...
1. Navigate to [DataVista | Homey](https://homey.app/a/nl.erikvl87.datavista/).
2. Log in with your Homey account if prompted.
3. Click **Install App** to add DataVista to your Homey.

Once installed, you can begin creating and customizing widgets to display data in your smart home.
